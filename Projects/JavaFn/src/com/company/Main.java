    ...
    public static void stringHandler() {
        ...
        switch (choice) {
            ...
            case 1:
                ...
                if (cipher.equals("1")) {
                    System.out.println("Encrypted string: " + Strings.encrypt(strToEncrypt, defaultCipher));
                } else {
                    System.out.println("Encrypted string:" + Strings.encrypt(strToEncrypt, cipher));
                }
                break;
            case 2:
                System.out.println("Enter your string: ");
                ...
                cipher = scanner.nextLine();
                if (cipher.equals("1")) {
                    System.out.println("Decrypted string: " + Strings.decrypt(strToDecrypt, defaultCipher));
                } else {
                    System.out.println("Decrypted string:" + Strings.decrypt(strToDecrypt, cipher));
                }
                break;
            case 3:
                System.out.println("Enter your string: ");
                ...
                System.out.println("Answer: " + Strings.checkPalindrome(checkPalinStr));
                break;
            case 4:
                System.out.println("Enter string to reverse: ");
                scanner.nextLine();
                strToReverse = scanner.nextLine();
                System.out.println("Here is your reversed string: " + Strings.reverse(strToReverse));
                break;
            default:
                System.out.println("Not an valid option.");
                break;
