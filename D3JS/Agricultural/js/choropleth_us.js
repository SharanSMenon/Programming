var ChoroplethUSA = function (data, parentElement, width, val, mnx) {
    this.data = data;
    ...
    this.mnx = mnx;
    this.domain = mnx;
    // this.range = this.mxn[1] - this.mnx[0];
    // this.range10 = this.range / 10;
    // for (let i = 0; i < 10; i++) {
    //     this.domain.push(this.mnx + (this.range10 * i))    
    // }
    this.initVis();
}
